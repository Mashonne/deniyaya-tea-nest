...
import { signInCustomer } from "@/lib/auth/mockAuth";
...
export default function SignInForm() {
  ...
  const onSubmit = async (data: SignInFormData) => {
    ...
    try {
      const user = await signInCustomer(data.email, data.password);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
        ...
        <div className="text-sm text-blue-700 space-y-1">
          <p>
            <strong>Email:</strong> saman.perera@email.com |{" "}
            <strong>Password:</strong> customer123
          </p>
          <p>
            <strong>Email:</strong> kumari.silva@email.com |{" "}
            <strong>Password:</strong> customer123
          </p>
          <p>
            <strong>Email:</strong> rajesh.fernando@email.com |{" "}
            <strong>Password:</strong> customer123
          </p>
          <p>
            <strong>Email:</strong> customer@deniyaya.com |{" "}
            <strong>Password:</strong> customer123
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="saman.perera@email.com"
            />
            {errors.email && (
